        ...
        <div class="pcoded-content">
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12">
                    <h4 class="font-weight-bolder">Reports</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h4 class="text-c-green">{{ $approvedLoanCount }}</h4>
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h4 class="text-c-red">{{ $rejectedLoanCount }}</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                ...
                                                <h6 class="text-muted m-b-0">Total Applications</h6>
                                            </div>
                                            <div class="col-4 text-right">
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row align-items-center">
                                            <div class="col-8">
                                                <h4 class="text-c-blue">{{ $totalUsers }}</h4>
